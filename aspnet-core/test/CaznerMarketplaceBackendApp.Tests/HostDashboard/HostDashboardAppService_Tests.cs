...
using CaznerMarketplaceBackendApp.MultiTenancy.HostDashboard;
...
namespace CaznerMarketplaceBackendApp.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(CaznerMarketplaceBackendAppDbContext context, SubscriptionPayment subscriptionPayment)
        {
