...
using CaznerMarketplaceBackendApp.Test.Base.TestData;
...
namespace CaznerMarketplaceBackendApp.Test.Base
{
    ...
    /// Provides methods to easily work with <see cref="CaznerMarketplaceBackendAppDbContext"/>.
    /// </summary>
    public abstract class AppTestBase<T> : AbpIntegratedTestBase<T> where T : AbpModule
    {
        ...
        {
            void NormalizeDbContext(CaznerMarketplaceBackendAppDbContext context)
            {
        ...
        protected void UsingDbContext(Action<CaznerMarketplaceBackendAppDbContext> action)
        {
            UsingDbContext(AbpSession.TenantId, action);
        }

        protected Task UsingDbContextAsync(Func<CaznerMarketplaceBackendAppDbContext, Task> action)
        {
            return UsingDbContextAsync(AbpSession.TenantId, action);
        }

        protected TResult UsingDbContext<TResult>(Func<CaznerMarketplaceBackendAppDbContext, TResult> func)
        {
            return UsingDbContext(AbpSession.TenantId, func);
        }

        protected Task<TResult> UsingDbContextAsync<TResult>(Func<CaznerMarketplaceBackendAppDbContext, Task<TResult>> func)
        {
            return UsingDbContextAsync(AbpSession.TenantId, func);
        }

        protected void UsingDbContext(int? tenantId, Action<CaznerMarketplaceBackendAppDbContext> action)
        {
            using (UsingTenantId(tenantId))
            {
                using (var context = LocalIocManager.Resolve<CaznerMarketplaceBackendAppDbContext>())
                {
                    action(context);
                    context.SaveChanges();
                }
        ...
        protected async Task UsingDbContextAsync(int? tenantId, Func<CaznerMarketplaceBackendAppDbContext, Task> action)
        {
            using (UsingTenantId(tenantId))
            {
                using (var context = LocalIocManager.Resolve<CaznerMarketplaceBackendAppDbContext>())
        ...
        protected TResult UsingDbContext<TResult>(int? tenantId, Func<CaznerMarketplaceBackendAppDbContext, TResult> func)
        {
            TResult result;
        ...
        protected async Task<TResult> UsingDbContextAsync<TResult>(int? tenantId, Func<CaznerMarketplaceBackendAppDbContext, Task<TResult>> func)
        {
            TResult result;
