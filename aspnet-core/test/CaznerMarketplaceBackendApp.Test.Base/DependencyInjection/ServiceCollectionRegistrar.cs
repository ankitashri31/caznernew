...
namespace CaznerMarketplaceBackendApp.Test.Base.DependencyInjection
{
    public static class ServiceCollectionRegistrar
    {
        public static void Register(IIocManager iocManager)
        {
            ...
            iocManager.IocContainer.Register(
                Component
                    .For<DbContextOptions<CaznerMarketplaceBackendAppDbContext>>()
            ...
            new CaznerMarketplaceBackendAppDbContext(builder.Options).Database.EnsureCreated();
        }
