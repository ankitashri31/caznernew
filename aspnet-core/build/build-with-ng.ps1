...
$webHostFolder = Join-Path $slnFolder "src/CaznerMarketplaceBackendApp.Web.Host"
$webPublicFolder = Join-Path $slnFolder "src/CaznerMarketplaceBackendApp.Web.Public"
