...
using CaznerMarketplaceBackendApp.Web.Public.Startup;
using CaznerMarketplaceBackendApp.Web.Session;

namespace CaznerMarketplaceBackendApp.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : CaznerMarketplaceBackendAppViewComponent
    {
