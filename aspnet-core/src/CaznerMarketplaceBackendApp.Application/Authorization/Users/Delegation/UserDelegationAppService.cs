...
namespace CaznerMarketplaceBackendApp.Authorization.Users.Delegation
{
    [AbpAuthorize]
    public class UserDelegationAppService : CaznerMarketplaceBackendAppAppServiceBase, IUserDelegationAppService
    {
