...
using CaznerMarketplaceBackendApp.Authorization.Permissions;
...
using CaznerMarketplaceBackendApp.Authorization.Users.Exporting;
...
namespace CaznerMarketplaceBackendApp.Authorization.Users
{
    ...
    public class UserAppService : CaznerMarketplaceBackendAppAppServiceBase, IUserAppService
    {
