...
using CaznerMarketplaceBackendApp.Authorization.Users.Profile.Cache;
...
using CaznerMarketplaceBackendApp.Gdpr;
...
{
    [AbpAuthorize]
    public class ProfileAppService : CaznerMarketplaceBackendAppAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("CaznerMarketplaceBackendApp",
