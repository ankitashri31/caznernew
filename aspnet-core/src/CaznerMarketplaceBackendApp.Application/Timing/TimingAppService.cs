...
{
    public class TimingAppService : CaznerMarketplaceBackendAppAppServiceBase, ITimingAppService
    {
        ...
        public async Task<ListResultDto<NameValueDto>> GetTimezones(GetTimezonesInput input)
        {
            ...
            timeZones = timeZones.Where(i => i.Name.ToLower().Contains("aus") || i.Name.ToLower().Contains("lord howe")).ToList();
