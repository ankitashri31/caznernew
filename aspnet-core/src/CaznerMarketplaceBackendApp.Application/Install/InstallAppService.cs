...
namespace CaznerMarketplaceBackendApp.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : CaznerMarketplaceBackendAppAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<CaznerMarketplaceBackendAppDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{CaznerMarketplaceBackendAppConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{CaznerMarketplaceBackendAppConsts.ConnectionStringName}", constring);
        }
