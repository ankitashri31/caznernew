...
using CaznerMarketplaceBackendApp.DynamicEntityPropertyValues.Dto;

namespace CaznerMarketplaceBackendApp.DynamicEntityProperties
{
    [Authorize(AppPermissions.Pages_Administration_DynamicEntityPropertyValue)]
    public class DynamicEntityPropertyValueAppService : CaznerMarketplaceBackendAppAppServiceBase, IDynamicEntityPropertyValueAppService
    {
