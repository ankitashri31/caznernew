...
namespace CaznerMarketplaceBackendApp.Notifications
{
    [AbpAuthorize]
    public class NotificationAppService : CaznerMarketplaceBackendAppAppServiceBase, INotificationAppService
    {
