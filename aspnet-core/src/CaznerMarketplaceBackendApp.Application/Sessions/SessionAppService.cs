...
{
    public class SessionAppService : CaznerMarketplaceBackendAppAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = CaznerMarketplaceBackendAppConsts.Currency,
                    CurrencySign = CaznerMarketplaceBackendAppConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = CaznerMarketplaceBackendAppConsts.AllowTenantsToChangeEmailSettings,
