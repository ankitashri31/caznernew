...
using CaznerMarketplaceBackendApp.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace CaznerMarketplaceBackendApp.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : CaznerMarketplaceBackendAppAppServiceBase, IDashboardCustomizationAppService
    {
