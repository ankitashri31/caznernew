...
namespace CaznerMarketplaceBackendApp.DataExporting.Excel.NPOI
{
    public abstract class NpoiExcelExporterBase : CaznerMarketplaceBackendAppServiceBase, ITransientDependency
    {
