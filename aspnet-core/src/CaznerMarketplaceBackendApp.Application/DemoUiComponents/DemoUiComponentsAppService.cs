...
using CaznerMarketplaceBackendApp.DemoUiComponents.Dto;

namespace CaznerMarketplaceBackendApp.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : CaznerMarketplaceBackendAppAppServiceBase, IDemoUiComponentsAppService
    {
