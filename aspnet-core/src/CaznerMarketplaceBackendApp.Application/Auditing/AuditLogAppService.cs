...
using CaznerMarketplaceBackendApp.Auditing.Exporting;
...
using EntityHistoryHelper = CaznerMarketplaceBackendApp.EntityHistory.EntityHistoryHelper;

namespace CaznerMarketplaceBackendApp.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : CaznerMarketplaceBackendAppAppServiceBase, IAuditLogAppService
    {
