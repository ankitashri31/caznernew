...
using CaznerMarketplaceBackendApp.MultiTenancy.Payments.Stripe;
...
{
    public class StripePaymentAppService : CaznerMarketplaceBackendAppAppServiceBase, IStripePaymentAppService
    {
