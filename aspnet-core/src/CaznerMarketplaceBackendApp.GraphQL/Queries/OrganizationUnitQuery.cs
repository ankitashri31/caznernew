...
using CaznerMarketplaceBackendApp.Core.Base;
using CaznerMarketplaceBackendApp.Core.Extensions;
using CaznerMarketplaceBackendApp.Dto;
using CaznerMarketplaceBackendApp.Types;

namespace CaznerMarketplaceBackendApp.Queries
{
    public class OrganizationUnitQuery : CaznerMarketplaceBackendAppQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
