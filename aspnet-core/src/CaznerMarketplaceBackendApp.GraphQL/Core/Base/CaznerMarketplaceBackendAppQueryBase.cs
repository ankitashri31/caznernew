...
namespace CaznerMarketplaceBackendApp.Core.Base
{
    public abstract class CaznerMarketplaceBackendAppQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected CaznerMarketplaceBackendAppQueryBase(string fieldName,
