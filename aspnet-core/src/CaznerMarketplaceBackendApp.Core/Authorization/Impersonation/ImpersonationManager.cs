...
namespace CaznerMarketplaceBackendApp.Authorization.Impersonation
{
    public class ImpersonationManager : CaznerMarketplaceBackendAppDomainServiceBase, IImpersonationManager
    {
