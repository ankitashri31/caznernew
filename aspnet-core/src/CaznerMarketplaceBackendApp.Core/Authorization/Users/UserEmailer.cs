...
namespace CaznerMarketplaceBackendApp.Authorization.Users
{
    ...
    /// </summary>
    public class UserEmailer : CaznerMarketplaceBackendAppServiceBase, IUserEmailer, ITransientDependency
    {
        ...
        public UserEmailer(
            ...
            IAbpSession abpSession, IConfiguration configuration)
        {
        ...
        public async Task<bool> SendEmail(MailMessage MailMessage)
        {
            ...
            try
            {
                ...
                if (Host != null)
                {
                    Message.To.Add(MailMessage.To.ToString());
                ...
                {
                    emailClient.Credentials = new System.Net.NetworkCredential(UserName, "");
                }
                else
                {
