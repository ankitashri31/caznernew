    ...
    public class UserManager : AbpUserManager<Role, User>
    {
        ...
        public async Task<string> CreateRandomPassword()
        {
            var passwordComplexitySetting = new PasswordComplexitySetting
            {
                ...
                RequiredLength = 8
                //await _settingManager.GetSettingValueAsync<int>(AbpZeroSettingNames.UserManagement.PasswordComplexity.RequiredLength)
            };
        ...
        {
            return _localizationManager.GetString(CaznerMarketplaceBackendAppConsts.LocalizationSourceName, name);
        }
    }
}