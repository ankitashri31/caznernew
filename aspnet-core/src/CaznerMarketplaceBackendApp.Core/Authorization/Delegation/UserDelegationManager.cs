...
namespace CaznerMarketplaceBackendApp.Authorization.Delegation
{
    public class UserDelegationManager : CaznerMarketplaceBackendAppServiceBase, IUserDelegationManager
    {
