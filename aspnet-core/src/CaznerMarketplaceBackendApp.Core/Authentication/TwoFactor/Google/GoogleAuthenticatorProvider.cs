...
namespace CaznerMarketplaceBackendApp.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : CaznerMarketplaceBackendAppServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("CaznerMarketplaceBackendApp", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
