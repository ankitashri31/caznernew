...
{
    public class StripeGatewayManager : CaznerMarketplaceBackendAppServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "CaznerMarketplaceBackendApp";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + CaznerMarketplaceBackendAppConsts.Currency;
        }
