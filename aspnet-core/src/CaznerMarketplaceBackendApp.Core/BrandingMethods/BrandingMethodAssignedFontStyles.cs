...
{
    public class BrandingMethodAssignedFontStyles : FullAuditedEntity<long>, IMustHaveTenant
    {
        public int TenantId { get; set; }
        public virtual BrandingSpecificFontStyleMaster BrandingSpecificFontStyleMaster { get; set; }
        [ForeignKey("BrandingSpecificFontTypeFaceMaster")]
        public long BrandingSpecificFontStyleId { get; set; }
