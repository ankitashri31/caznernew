...
using CaznerMarketplaceBackendApp.Authorization.Ldap;
...
using CaznerMarketplaceBackendApp.DashboardCustomization.Definitions;
using CaznerMarketplaceBackendApp.Debugging;
using CaznerMarketplaceBackendApp.DynamicEntityProperties;
using CaznerMarketplaceBackendApp.Features;
using CaznerMarketplaceBackendApp.Friendships;
using CaznerMarketplaceBackendApp.Friendships.Cache;
using CaznerMarketplaceBackendApp.Localization;
using CaznerMarketplaceBackendApp.MultiTenancy;
using CaznerMarketplaceBackendApp.Net.Emailing;
using CaznerMarketplaceBackendApp.Notifications;
using CaznerMarketplaceBackendApp.WebHooks;

namespace CaznerMarketplaceBackendApp
{
    [DependsOn(
        typeof(CaznerMarketplaceBackendAppCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class CaznerMarketplaceBackendAppCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            CaznerMarketplaceBackendAppLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = CaznerMarketplaceBackendAppConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, CaznerMarketplaceBackendAppMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<CaznerMarketplaceBackendAppSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(CaznerMarketplaceBackendAppCoreModule).GetAssembly());
        }
