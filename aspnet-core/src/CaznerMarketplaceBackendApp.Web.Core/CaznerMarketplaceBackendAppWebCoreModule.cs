...
using CaznerMarketplaceBackendApp.Web.Configuration;
using CaznerMarketplaceBackendApp.Web.DashboardCustomization;
...
namespace CaznerMarketplaceBackendApp.Web
{
    ...
    public class CaznerMarketplaceBackendAppWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public CaznerMarketplaceBackendAppWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(CaznerMarketplaceBackendAppApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(CaznerMarketplaceBackendAppWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(CaznerMarketplaceBackendAppWebCoreModule).Assembly);
        }
