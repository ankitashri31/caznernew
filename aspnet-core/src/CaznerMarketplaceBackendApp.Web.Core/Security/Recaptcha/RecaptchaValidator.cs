...
namespace CaznerMarketplaceBackendApp.Web.Security.Recaptcha
{
    public class RecaptchaValidator : CaznerMarketplaceBackendAppServiceBase, IRecaptchaValidator, ITransientDependency
    {
