...
{
    public class SubscriptionPaymentRepository : CaznerMarketplaceBackendAppRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<CaznerMarketplaceBackendAppDbContext> dbContextProvider)
