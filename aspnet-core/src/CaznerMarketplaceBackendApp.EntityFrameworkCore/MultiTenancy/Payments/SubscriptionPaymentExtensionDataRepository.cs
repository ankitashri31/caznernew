...
using CaznerMarketplaceBackendApp.EntityFrameworkCore.Repositories;

namespace CaznerMarketplaceBackendApp.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : CaznerMarketplaceBackendAppRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<CaznerMarketplaceBackendAppDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
