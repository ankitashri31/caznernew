...
namespace CaznerMarketplaceBackendApp.Migrations.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = CaznerMarketplaceBackendAppConsts.MultiTenancyEnabled ? null : (int?)1;
        ...
        public DefaultLanguagesCreator(CaznerMarketplaceBackendAppDbContext context)
        {
            _context = context;
        }
