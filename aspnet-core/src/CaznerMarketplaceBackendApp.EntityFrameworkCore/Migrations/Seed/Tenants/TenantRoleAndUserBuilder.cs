...
namespace CaznerMarketplaceBackendApp.Migrations.Seed.Tenants
{
    public class TenantRoleAndUserBuilder
    {
        ...
        public TenantRoleAndUserBuilder(CaznerMarketplaceBackendAppDbContext context, int tenantId)
        {
            _context = context;
            _tenantId = tenantId;
        }
