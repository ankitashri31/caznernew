...
namespace CaznerMarketplaceBackendApp.Migrations
{
    ...
    [Migration("20210421045136_Added_ProductVariantBulkImportHistory_Table")]
    partial class Added_ProductVariantBulkImportHistory_Table
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CaznerMarketplaceBackendApp.Product.Masters.ProductBulkImportDataHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long?>("PriceVariantsId")
                        .HasColumnType("bigint");
                    ...
                    b.Property<long?>("ProductMediaImagesId")
                        .HasColumnType("bigint");

                    b.Property<long?>("ProductVolumeDiscountVariantId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("ProductMediaImagesId");

                    b.HasIndex("ProductVolumeDiscountVariantId");

                    b.ToTable("ProductBulkImportDataHistory");
                });
            ...
            modelBuilder.Entity("CaznerMarketplaceBackendApp.Product.Masters.ProductVariantBulkImportHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long?>("BulkUploadVariationsId")
                        .HasColumnType("bigint");
                    ...
                    b.Property<long?>("VariantDataId")
                        .HasColumnType("bigint");

                    b.Property<long?>("VariantOptionId")
                        .HasColumnType("bigint");

                    b.Property<long?>("VariantWarehouseId")
                        .HasColumnType("bigint");

                    b.Property<long?>("VariantdataImageId")
                        .HasColumnType("bigint");

                    b.HasKey("Id");

                    b.HasIndex("BulkUploadVariationsId");

                    b.HasIndex("VariantDataId");

                    b.HasIndex("VariantOptionId");

                    b.HasIndex("VariantWarehouseId");

                    b.HasIndex("VariantdataImageId");

                    b.ToTable("ProductVariantBulkImportHistory");
                });
            ...
            modelBuilder.Entity("CaznerMarketplaceBackendApp.Product.ProductBrandingPriceVariants", b =>
                {
                    ...
                    b.Property<long?>("ProductBulkImportDataHistoryId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("ProductBulkImportDataHistoryId");
            ...
            modelBuilder.Entity("CaznerMarketplaceBackendApp.Product.ProductDimension", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("CaznerMarketplaceBackendApp.Product.ProductInventory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("CaznerMarketplaceBackendApp.Product.ProductPackageDimension", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("ProductPackageDimension");
                });
            ...
            modelBuilder.Entity("CaznerMarketplaceBackendApp.Product.ProductVariantOptionValues", b =>
                {
                    ...
                    b.Property<long?>("ProductVariantBulkImportHistoryId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("ProductVariantBulkImportHistoryId");
            ...
            modelBuilder.Entity("CaznerMarketplaceBackendApp.Product.Masters.ProductBulkImportDataHistory", b =>
                {
                    b.HasOne("CaznerMarketplaceBackendApp.Product.ProductBrandingPriceVariants", "ProductBrandingPriceVariants")
                        .WithMany()
                        .HasForeignKey("PriceVariantsId");

                    b.HasOne("CaznerMarketplaceBackendApp.Product.ProductDetails", "ProductDetails")
                        .WithMany()
                        .HasForeignKey("ProductDetailsId");

                    b.HasOne("CaznerMarketplaceBackendApp.Product.ProductDimension", "ProductDimension")
                        .WithMany()
                        .HasForeignKey("ProductDimensionId");

                    b.HasOne("CaznerMarketplaceBackendApp.Product.ProductImages", "ProductImages")
                        .WithMany()
                        .HasForeignKey("ProductImagesId");

                    b.HasOne("CaznerMarketplaceBackendApp.Product.ProductDimensionsInventory", "ProductDimensionsInventory")
                        .WithMany()
                    ...
                    b.HasOne("CaznerMarketplaceBackendApp.Product.ProductMediaImages", "ProductMediaImages")
                        .WithMany()
                        .HasForeignKey("ProductMediaImagesId");

                    b.HasOne("CaznerMarketplaceBackendApp.Product.ProductVolumeDiscountVariant", "ProductVolumeDiscountVariant")
                        .WithMany()
                        .HasForeignKey("ProductVolumeDiscountVariantId");
                });

            modelBuilder.Entity("CaznerMarketplaceBackendApp.Product.Masters.ProductVariantBulkImportHistory", b =>
                {
                    b.HasOne("CaznerMarketplaceBackendApp.Product.ProductBulkUploadVariations", "ProductBulkUploadVariations")
                        .WithMany()
                        .HasForeignKey("BulkUploadVariationsId");

                    b.HasOne("CaznerMarketplaceBackendApp.Product.ProductVariantsData", "ProductVariantsData")
                        .WithMany()
                        .HasForeignKey("VariantDataId");

                    b.HasOne("CaznerMarketplaceBackendApp.Product.ProductVariantOptionValues", "ProductVariantOptionValues")
                        .WithMany()
                        .HasForeignKey("VariantOptionId");

                    b.HasOne("CaznerMarketplaceBackendApp.Product.ProductVariantWarehouse", "ProductVariantWarehouse")
                        .WithMany()
                        .HasForeignKey("VariantWarehouseId");

                    b.HasOne("CaznerMarketplaceBackendApp.Product.ProductVariantdataImages", "ProductVariantdataImages")
                        .WithMany()
                        .HasForeignKey("VariantdataImageId");
                });
            ...
            modelBuilder.Entity("CaznerMarketplaceBackendApp.Product.ProductBrandingPriceVariants", b =>
                {
                    ...
                    b.HasOne("CaznerMarketplaceBackendApp.Product.Masters.ProductBulkImportDataHistory", null)
                        .WithMany("BrandingPriceVariantsList")
                        .HasForeignKey("ProductBulkImportDataHistoryId");
            ...
            modelBuilder.Entity("CaznerMarketplaceBackendApp.Product.ProductVariantOptionValues", b =>
                {
                    b.HasOne("CaznerMarketplaceBackendApp.Product.Masters.ProductVariantBulkImportHistory", null)
                        .WithMany("BrandingPriceVariantsList")
                        .HasForeignKey("ProductVariantBulkImportHistoryId");
            ...
            modelBuilder.Entity("CaznerMarketplaceBackendApp.Product.ProductVariantdataImages", b =>
                {
                    ...
                    b.HasOne("CaznerMarketplaceBackendApp.Product.Masters.ProductVariantBulkImportHistory", null)
                        .WithMany("VariantdataImagesList")
                        .HasForeignKey("ProductVariantBulkImportHistoryId");
