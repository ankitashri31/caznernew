...
using CaznerMarketplaceBackendApp.Web.Startup.ExternalLoginInfoProviders;
...
namespace CaznerMarketplaceBackendApp.Web.Startup
{
    ...
    public class CaznerMarketplaceBackendAppWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public CaznerMarketplaceBackendAppWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(CaznerMarketplaceBackendAppWebHostModule).GetAssembly());
        }
