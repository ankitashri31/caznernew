...
using CaznerMarketplaceBackendApp.Web.Models.Consent;

namespace CaznerMarketplaceBackendApp.Web.Host.Controllers
{
    public class ConsentController : CaznerMarketplaceBackendAppControllerBase
    {
