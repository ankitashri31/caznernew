...
using CaznerMarketplaceBackendApp.Commands;
using CaznerMarketplaceBackendApp.Core.Threading;
using CaznerMarketplaceBackendApp.Models.NavigationMenu;
using CaznerMarketplaceBackendApp.Services.Navigation;
using CaznerMarketplaceBackendApp.ViewModels.Base;
using Plugin.Media;
...
using CaznerMarketplaceBackendApp.Controls;
using CaznerMarketplaceBackendApp.Dto;
using CaznerMarketplaceBackendApp.Extensions;
using CaznerMarketplaceBackendApp.Localization;
using CaznerMarketplaceBackendApp.UI;
using CaznerMarketplaceBackendApp.UI.Assets;
using CaznerMarketplaceBackendApp.Views;
using DependencyResolver = CaznerMarketplaceBackendApp.Core.Dependency.DependencyResolver;

namespace CaznerMarketplaceBackendApp.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "CaznerMarketplaceBackendApp";
