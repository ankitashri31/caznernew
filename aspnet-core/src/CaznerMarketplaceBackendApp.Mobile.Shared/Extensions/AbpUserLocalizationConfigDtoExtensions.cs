...
namespace CaznerMarketplaceBackendApp.Extensions
{
    public static class AbpUserLocalizationConfigDtoExtensions
    {
        ...
        {
            return Localize(userLocalizationConfig, key, CaznerMarketplaceBackendAppConsts.LocalizationSourceName, args);
        }
    }
}
