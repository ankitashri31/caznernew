...
import { CaznerMarketplaceBackendAppCommonModule } from '@shared/common/common.module';
...
function initializeLocalForage() {
    localForage.config({
        ...
        name: 'CaznerMarketplaceBackendApp',
        version: 1.0,
        storeName: 'abpzerotemplate_local_storage',
        description: 'Cached data for CaznerMarketplaceBackendApp'
    });
}
...
@NgModule({
    imports: [
        ...
        AppModule,
        CaznerMarketplaceBackendAppCommonModule.forRoot(),
        ServiceProxyModule,
        HttpClientModule,
        RootRoutingModule,
        NgxSpinnerModule
